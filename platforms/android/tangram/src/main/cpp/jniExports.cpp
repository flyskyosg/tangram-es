...
extern "C" {
    ...
    JNIEXPORT void JNICALL Java_com_mapzen_tangram_MapController_nativeOnUrlSuccess(JNIEnv* jniEnv, jobject obj, jlong callbackPtr, jbyteArray fetchedBytes) {
        AndroidPlatform::onUrlSuccess(jniEnv, callbackPtr, fetchedBytes);
    }

    JNIEXPORT void JNICALL Java_com_mapzen_tangram_MapController_nativeOnUrlFailure(JNIEnv* jniEnv, jobject obj, jlong callbackPtr, jstring error) {
        AndroidPlatform::onUrlFailure(jniEnv, callbackPtr, error);
    }
